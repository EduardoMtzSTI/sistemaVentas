...
<html>
	...
	<body>
		<a href="#edit-venta" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-venta" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:ventaInstance, action:'update']" method="PUT" >
